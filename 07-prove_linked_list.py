...
class LinkedList:
    ...
    def insert_tail(self, value):
        ...
        if self.tail is None:
            ...
            new_node.prev = self.tail  # set previous of the new node to the current tail
            self.tail.next = new_node  # set next of the current tail to the new node
            self.tail = new_node  # set tail equal to the new_node
    ...
    def remove_tail(self):
        ...
        """
        # if only one node in the list set head and tail to none
        if self.tail == self.head:
            self.tail = None
            self.head = None
        # if there is more than one item in the list set the next of the previous node to none
        # and set the tail to the second to last node
    ...
    def __reversed__(self):
        ...
        """
        curr = self.tail  # start at the tail for a backward iteration
        while curr is not None:
            yield curr.data
            curr = curr.prev  # go to the previous node in the list
